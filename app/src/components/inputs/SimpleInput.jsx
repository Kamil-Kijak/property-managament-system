...
export default function SimpleInput({type = "text", title = "title", placeholder="placeholder...", value = "", step = null, min = null, onChange=() =>{}, error=null}) {
    return (
        <section className="flex flex-col items-start mb-5 relative">
            ...
            <input autoComplete="off" type={type} step={step} min={min} onChange={onChange}  placeholder={placeholder} className={`border-3 ${error ? "border-red-700" : "border-black"} p-2 rounded-md bg-white`} value={value || ""} />
