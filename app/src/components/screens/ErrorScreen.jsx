...
export default function ErrorScreen({desc}) {
    ...
    return (
        ...
        <section className="fixed top-0 left-1/12 right-1/12 bg-red-700 z-20 p-3 rounded-b-2xl flex">
            <button onClick={() => screens.error.set(false)} className=" p-2 rounded-full cursor-pointer bg-red-700 hover:bg-red-600 w-[40px] h-[40px] transition-colors duration-150 ease-in-out"><FontAwesomeIcon icon={faXmark} className="text-2xl text-white"/></button>
